...
bmad_conventions:
  ...
  agent_command_patterns: "{project-root}/bmad/bmb/workflows/create-agent/agent-command-patterns.md"
  agent_types: "{project-root}/bmad/bmb/workflows/create-agent/agent-types.md"
  module_structure: "{project-root}/bmad/bmb/workflows/create-module/module-structure.md"
  workflow_guide: "{project-root}/bmad/bmb/workflows/create-workflow/workflow-creation-guide.md"

# Runtime inputs
target_path: "" # User specifies: module path, workflow path, agent path, or folder path

# Module path and component files
installed_path: "{project-root}/bmad/bmb/workflows/redoc"
