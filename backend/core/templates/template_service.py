...
class ChainlensDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_chainlens_default_agent(agent):
            raise ChainlensDefaultAgentTemplateError("Cannot create template from Chainlens default agent")
    ...
    async def get_public_templates(
        self,
        is_epsilon_team: Optional[bool] = None,
        ...
        if is_epsilon_team is not None:
            query = query.eq('is_epsilon_team', is_epsilon_team)
    ...
    def _is_chainlens_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_chainlens_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_epsilon_team=data.get('is_epsilon_team', False),
