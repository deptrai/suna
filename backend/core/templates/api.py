...
from .template_service import (
    ...
    ChainlensDefaultAgentTemplateError
)
...
class TemplateResponse(BaseModel):
    ...
    categories: List[str]
    is_public: bool
    is_epsilon_team: Optional[bool] = False
...
async def create_template_from_agent(
    ...
    except ChainlensDefaultAgentTemplateError as e:
        logger.warning(f"Template creation failed - Chainlens default agent: {e}")
...
async def get_marketplace_templates(
    ...
    is_epsilon_team: Optional[bool] = Query(None, description="Filter for Epsilon team templates"),
    ...
    try:
        ...
        filters = MarketplaceFilters(
            search=search,
            tags=tags_list,
            is_epsilon_team=is_epsilon_team,
