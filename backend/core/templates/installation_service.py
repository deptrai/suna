...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_epsilon_team:
            metadata['is_epsilon_team'] = True
            metadata['epsilon_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_epsilon_team: {template.is_epsilon_team}")
        return agent_id
