...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@epsilon.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Chainlens Team')
...
<head>
  ...
  <title>Welcome to Epsilon Chainlens</title>
  <style>
    body {{
...
<body>
  <div class="container">
    ...
    <p><em><strong>Welcome to Epsilon Chainlens — we're excited to have you on board!</strong></em></p>
    ...
    <p><strong>For your business:</strong> if you want to automate manual and ordinary tasks for your company, book a call with us <a href="https://cal.com/team/epsilon/enterprise-demo">here</a></p>

    <p>Thanks again, and welcome to the Chainlens community <span class="emoji">🌞</span></p>
...
For your business: if you want to automate manual and ordinary tasks for your company, book a call with us here: https://cal.com/team/epsilon/enterprise-demo 

Thanks again, and welcome to the Chainlens community 🌞

— The Chainlens Team

Go to the platform: https://www.chainlens.net/

---
© 2025 Chainlens. All rights reserved.
You received this email because you signed up for a Chainlens account."""
