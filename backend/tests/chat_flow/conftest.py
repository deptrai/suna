"""
Test fixtures for chat flow tests.

BMAD Test Strategy: Integration Tests
- Real ThreadManager (not mocked)
- Real LLM calls (for accuracy)
- Real database (test isolation)
...
def sample_queries():
    ...
    Returns:
        Dictionary of sample queries for different categories
    """
    return {
        'simple': "What is 2+2?",
...
def sample_data(tmp_path):
    """
    Fixture for test data files.
    
    Args:
        tmp_path: pytest tmp_path fixture
        
    Returns:
        Dictionary of test data file paths
    """
    # Create test CSV
    ...
    json_file.write_text('{"name": "Alice", "age": 30, "city": "NYC"}')
