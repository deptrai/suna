...
export const TOOL_DISPLAY_NAMES: ReadonlyMap<string, string> = new Map([
  ...
  // Epsilon session tools
  ['session_spawn', 'Spawning Session'],
  ['session-spawn', 'Spawning Session'],
  ['session_start_background', 'Starting Background Session'],
  ['session-start-background', 'Starting Background Session'],
  ['session_read', 'Reading Session'],
  ['session-read', 'Reading Session'],
  ['session_get', 'Getting Session Details'],
  ['session-get', 'Getting Session Details'],
  ['session_search', 'Searching Sessions'],
  ['session-search', 'Searching Sessions'],
  ['session_message', 'Messaging Session'],
  ['session-message', 'Messaging Session'],
  ['session_lineage', 'Tracing Session Lineage'],
  ['session-lineage', 'Tracing Session Lineage'],
  ['session_stats', 'Getting Session Stats'],
  ['session-stats', 'Getting Session Stats'],
  ['session_list', 'Listing Sessions'],
  ['session-list', 'Listing Sessions'],
  ['session_list_background', 'Listing Background Sessions'],
  ['session-list-background', 'Listing Background Sessions'],
  ['session_list_spawned', 'Listing Spawned Sessions'],
  ['session-list-spawned', 'Listing Spawned Sessions'],
  ['session_context', 'Loading Session Context'],
  ['session-context', 'Loading Session Context'],

  // Epsilon trigger management (unified `triggers` tool)
  ['triggers', 'Managing Triggers'],
  ['trigger_create', 'Creating Trigger'],
  ['trigger-create', 'Creating Trigger'],
  ['trigger_list', 'Listing Triggers'],
  ['trigger-list', 'Listing Triggers'],
  ['trigger_get', 'Getting Trigger Details'],
  ['trigger-get', 'Getting Trigger Details'],
  ['trigger_delete', 'Deleting Trigger'],
  ['trigger-delete', 'Deleting Trigger'],
  ['trigger_update', 'Updating Trigger'],
  ['trigger-update', 'Updating Trigger'],
  ['trigger_test', 'Testing Trigger'],
  ['trigger-test', 'Testing Trigger'],
  ['trigger_pause', 'Pausing Trigger'],
  ['trigger-pause', 'Pausing Trigger'],
  ['trigger_resume', 'Resuming Trigger'],
  ['trigger-resume', 'Resuming Trigger'],
