...
const envSchema = z.object({
  ...
  FREE_THINK_MODEL_POOL:               optStr,
  PREMIUM_THINK_MODEL_POOL:            optStr,
  FREE_THINK_BUDGET_TOKENS:            optInt(5000),
  PREMIUM_THINK_BUDGET_TOKENS:         optInt(10000),
...
export const config = {
  ...
  FREE_THINK_MODEL_POOL: env.FREE_THINK_MODEL_POOL,
  PREMIUM_THINK_MODEL_POOL: env.PREMIUM_THINK_MODEL_POOL,
  FREE_THINK_BUDGET_TOKENS: env.FREE_THINK_BUDGET_TOKENS,
  PREMIUM_THINK_BUDGET_TOKENS: env.PREMIUM_THINK_BUDGET_TOKENS,
