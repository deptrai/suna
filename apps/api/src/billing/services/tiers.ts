...
const TIERS: Record<string, TierConfig> = {
  ...
  free: {
    ...
    monthlyCredits: 0,
    canPurchaseCredits: false,
    monthlyTokenGrant: config.TIER1_MONTHLY_TOKENS,
    canPurchaseTopup: false,
  ...
  pro: {
    ...
    stripeMonthlyPriceId: config.STRIPE_PRICE_TIER2_MONTHLY || null,
    models: ['all'],
    dailyCreditConfig: null,
    hidden: false,
  },
  enterprise: {
    ...
    canPurchaseTopup: true,
    stripeMonthlyPriceId: config.STRIPE_PRICE_TIER3_MONTHLY || null,
    models: ['all'],
    dailyCreditConfig: null,
    hidden: false,
  },
