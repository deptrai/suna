...
interface EpsilonComputerState {
  // Main view state
  activeView: ViewType;
  ...
  // Clear pending tool nav after EpsilonComputer processes it
...
export const useEpsilonComputerStore = create<EpsilonComputerState>((set, get) => ({
  ...initialState,
...
export const useEpsilonComputerActiveView = () => 
  useEpsilonComputerStore((state) => state.activeView);

export const useEpsilonComputerIsOpen = () =>
  useEpsilonComputerStore((state) => state.isOpen);

// Individual selectors for files state (stable, primitive values)
export const useEpsilonComputerFilesSubView = () =>
  useEpsilonComputerStore((state) => state.filesSubView);

export const useEpsilonComputerCurrentPath = () =>
  useEpsilonComputerStore((state) => state.currentPath);

export const useEpsilonComputerSelectedFilePath = () =>
  useEpsilonComputerStore((state) => state.selectedFilePath);

export const useEpsilonComputerFilePathList = () =>
  useEpsilonComputerStore((state) => state.filePathList);

export const useEpsilonComputerCurrentFileIndex = () =>
  useEpsilonComputerStore((state) => state.currentFileIndex);

// Individual selectors for pending tool navigation (stable primitives)
export const useEpsilonComputerPendingToolNavIndex = () =>
  useEpsilonComputerStore((state) => state.pendingToolNavIndex);

export const useEpsilonComputerClearPendingToolNav = () =>
  useEpsilonComputerStore((state) => state.clearPendingToolNav);

// Version history selectors
export const useEpsilonComputerSelectedVersion = () =>
  useEpsilonComputerStore((state) => state.selectedVersion);

export const useEpsilonComputerSelectedVersionDate = () =>
  useEpsilonComputerStore((state) => state.selectedVersionDate);

export const useEpsilonComputerVersionActions = () =>
  useEpsilonComputerStore((state) => ({
