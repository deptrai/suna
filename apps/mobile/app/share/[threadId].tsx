...
import { EpsilonComputer } from '@/components/epsilon-computer';
...
export default function ShareThreadPage() {
  ...
  // Epsilon Computer for viewing tool calls
  const { isOpen: isEpsilonComputerOpen, openPanel } = useEpsilonComputerStore();
  const [selectedToolData, setSelectedToolData] = React.useState<{
    toolMessages: ToolMessagePair[];
    initialIndex: number;
  } | null>(null);

  // Handle tool press - open Epsilon Computer
