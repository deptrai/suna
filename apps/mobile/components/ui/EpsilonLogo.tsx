...
import EpsilonSymbolBlack from '@/assets/brand/epsilon-symbol.svg';
import EpsilonSymbolWhite from '@/assets/brand/Symbol.svg';
import LogomarkBlack from '@/assets/brand/Logomark-Black.svg';
import LogomarkWhite from '@/assets/brand/Logomark-White.svg';

interface EpsilonLogoProps extends Omit<ViewProps, 'style'> {
  size?: number;
...
export function EpsilonLogo({ 
  ...
  const SymbolComponent = color === 'dark' ? EpsilonSymbolWhite : EpsilonSymbolBlack;
