...
export interface PricingTier {
  ...
  revenueCatId?: string; // RevenueCat product identifier (e.g., 'epsilon_plus_monthly')
}
...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      '1 concurrent run',
      '1 Chat',
      'Basic Mode - Core Epsilon experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      // '5 custom AI Workers - Create Epsilon Agents with custom Knowledge, Tools & Integrations',
      ...
      'Epsilon Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
    isPopular: true,
    buttonText: 'Get started',
    hidden: false,
    icon: Zap,
    revenueCatId: 'epsilon_plus',
  },
  {
    id: 'tier_6_50',
    name: 'Pro',
    ...
    features: [
      ...
      // '20 custom AI Workers - Create Epsilon Agents with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      // '100 custom AI Workers - Create Epsilon Agents with custom Knowledge, Tools & Integrations',
