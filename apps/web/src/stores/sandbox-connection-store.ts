...
interface SandboxConnectionStore {
	...
	/** Current sandbox version from /epsilon/health (e.g. "0.5.1") */
...
const STORAGE_KEY = "epsilon-sandbox-was-connected";
const PROVISION_VERIFIED_KEY = "epsilon-sandbox-provision-verified";
