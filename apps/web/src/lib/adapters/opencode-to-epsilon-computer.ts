/**
 * Adapter: OpenCode SDK ToolPart → EpsilonComputer ToolCallInput
 *
 * Converts OpenCode session messages into the ToolCallInput[] format
 * that EpsilonComputer expects, enabling the computer panel to display
 * OpenCode tool calls.
 */

import type { MessageWithParts, ToolPart, ToolState } from '@/ui';
import type { ToolCallInput } from '@/components/thread/epsilon-computer/EpsilonComputer';
 ...
 * the ToolCallInput[] format used by EpsilonComputer.
 */
