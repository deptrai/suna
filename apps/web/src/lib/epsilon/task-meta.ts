 ...
 *
 * Mirrors the canonical task statuses exposed by the live /epsilon/tasks API.
 */
...
export const STATUS_META: Record<EpsilonTaskStatus, StatusMeta> = {
  todo: {
    icon: Circle,
...
export const ALL_STATUSES: EpsilonTaskStatus[] = [
  'todo',
  'in_progress',
  'input_needed',
  'awaiting_review',
