/**
 * OpenCode File API — filesystem access via the SDK client + epsilon-master.
 *
 ...
 * use `authenticatedFetch()` to hit epsilon-master's /file/* routes
 ...
 * epsilon-master's /file/upload endpoint places it correctly.
 */
