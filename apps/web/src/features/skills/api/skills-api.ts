 ...
 * - Create/Update: writes SKILL.md via epsilon-master /file/upload
 * - Delete: removes the skill directory via epsilon-master DELETE /file
 *
 ...
 * Posts directly to epsilon-master's /file/upload endpoint.
 */
