...
export const WallpaperBackground = memo(function WallpaperBackground({
  ...
  // ── Variant 1: Brandmark ──────────────────────────────────────────────
  // Full-bleed oversized Epsilon symbol outline, faded
  ...
  // ── Variant 2: Symbol ─────────────────────────────────────────────────
  // Tiny Epsilon symbol, dead center, ghost-level opacity
  ...
  if (wallpaper.type === 'aurora') {
    return (
      ...
      >
        ...
        {/* L2 — Epsilon logomark, sized relative to the actual container so
