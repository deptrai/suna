...
/**
 * EpsilonLoader - A unified circular loading animation component
 * 
 ...
 * <EpsilonLoader variant="white" />
 * 
 * // Always black (for light backgrounds in any theme)
 * <EpsilonLoader variant="black" />
 * 
 * // Custom size
      ...
      <div
        style={{
          ...
          animation: autoPlay && loop
            ? `epsilon-spin ${animationDuration}s linear infinite`
            : autoPlay
              ? `epsilon-spin ${animationDuration}s linear`
              : 'none',
        }}
      />
    </div>
