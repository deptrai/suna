...
import '../../tool-views/spreadsheet/epsilon-spreadsheet-styles.css';
    ...
    <div className="flex items-center bg-zinc-100/80 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-800">
      ...
      <div className="flex items-center border-l border-zinc-200 dark:border-zinc-800 shrink-0">
        ...
        {activeTabId && !showHome && (
          ...
          >
            {activeEditorHandle?.isSyncing ? <EpsilonLoader size="small" /> : <RefreshCw className="w-4 h-4" />}
          </button>
        )}
        <button
          onClick={goToHome}
            ...
            {(searchQuery ? filteredFiles : spreadsheetFiles).length > 0 ? (
              (searchQuery ? filteredFiles : spreadsheetFiles).map((file, index) => (
                <motion.button
                  ...
                  className="w-full flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-muted/50 transition-colors group text-left"
                >
              ...
              <div className="flex flex-col items-center justify-center py-20 text-zinc-400">
                ...
                >
                  {isCreating && <EpsilonLoader size="small" />}
