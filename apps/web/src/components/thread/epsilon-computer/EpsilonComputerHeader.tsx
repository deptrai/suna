...
interface EpsilonComputerHeaderProps {
...
/**
 * Shared header component for all Epsilon Computer views (Files, File Viewer, Browser).
 ...
 */
export function EpsilonComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
