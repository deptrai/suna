...
import { TaskKanban } from '@/components/epsilon/task-kanban';
import { TaskList } from '@/components/epsilon/task-list';
import type {
  EpsilonTask,
  EpsilonTaskStatus,
...
const VIEW_STORAGE_KEY = 'epsilon:tasks-view';
...
interface TasksTabProps {
  tasks: EpsilonTask[];
  filteredTasks: EpsilonTask[];
  search: string;
  setSearch: (v: string) => void;
  searchRef: React.RefObject<HTMLInputElement | null>;
  onStartTask: (id: string) => void;
  onApproveTask: (id: string) => void;
  onOpenTask: (task: EpsilonTask) => void;
  onNewTask: (status?: EpsilonTaskStatus) => void;
