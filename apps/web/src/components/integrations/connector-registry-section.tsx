...
function ConnectorCard({ connector, pipedreamConnections }: { connector: EpsilonConnector; pipedreamConnections: IntegrationConnection[] }) {
...
export function ConnectorRegistrySection({ pipedreamConnections }: { pipedreamConnections: IntegrationConnection[] }) {
  const { data: connectors, isLoading } = useEpsilonConnectors();
