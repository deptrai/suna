...
const stackStudies = [
  {
    ...
    rows: [
      ...
      ['Epsilon orchestration', 'Memory, integrations, scheduling, tunnels'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Epsilon keeps it organized', 'Cron, routing, memory, integrations'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Epsilon', 'Routes intent and keeps memory coherent'],
...
const filesystemProof = [
  ...
  '/workspace/.local/share/opencode/storage/epsilon-memory.db',
          ...
          <div>
            <Reveal delay={0.03}>
              ...
              <h1 className="mt-4 max-w-4xl text-4xl font-medium tracking-tight text-foreground sm:text-5xl md:text-6xl">
                A calmer way to evaluate how Epsilon should explain itself.
              </h1>
