...
export const metadata: Metadata = {
  ...
  keywords:
    'Epsilon careers, Epsilon jobs, AI startup jobs, autonomous company jobs, San Francisco AI jobs, agent engineering, startup hiring',
  openGraph: {
    title: 'Careers at Epsilon – Build the Autonomous Company OS',
    description:
    ...
    url: 'https://www.epsilon.com/careers',
    images: [
      {
        url: '/images/careers/shackleton.png',
        width: 380,
        height: 253,
        alt: 'Careers at Epsilon',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.epsilon.com/careers',
  },
};
