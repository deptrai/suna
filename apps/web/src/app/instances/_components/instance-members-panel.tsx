...
import {
  ...
  IconMore,
  IconUsers,
} from '@/components/ui/epsilon-icons';
      ...
      <header className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            ...
            they get instant access if they already use Epsilon, otherwise we
        ...
        >
          ...
          <div className="border-border/60 bg-muted/20 flex items-center justify-between gap-2 border-t px-6 py-3.5">
            <p className="text-muted-foreground/70 text-[11px]">
              If they don't have Epsilon yet, we'll send a signup link.
            </p>
