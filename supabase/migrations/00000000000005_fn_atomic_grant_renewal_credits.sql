-- atomic_grant_renewal_credits: Grants monthly renewal credits with
-- idempotency via renewal_processing table. Used by Stripe webhook
-- handler and yearly rotation job.
...
BEGIN
    ...
    FROM epsilon.credit_accounts WHERE account_id = p_account_id;
    ...
    INSERT INTO epsilon.credit_ledger (
