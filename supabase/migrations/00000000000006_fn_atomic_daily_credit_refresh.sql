-- atomic_daily_credit_refresh: Resets daily credits balance to the configured
-- amount. Idempotent via daily_refresh_tracking table.
...
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'epsilon', 'public'
AS $function$
DECLARE
