...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Epsilon',
    ...
    openGraph: {
      title: 'Shared Conversation | Epsilon',
      description: 'Replay this Agent conversation on Epsilon',
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Epsilon';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Epsilon';
