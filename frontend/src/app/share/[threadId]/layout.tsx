...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Epsilon Chainlens',
    description: 'Replay this Agent conversation on Epsilon Chainlens',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Epsilon Chainlens';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Epsilon Chainlens';
