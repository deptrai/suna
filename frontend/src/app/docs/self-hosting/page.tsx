...
cd chainlens`
      ...
      <DocsBody className="mb-8">
        <h2 id="step-5-start">Step 5: Start Epsilon</h2>
...
docker compose down`
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">You should see the Epsilon dashboard where you can start chatting with Chainlens or create your own agents.</p>
