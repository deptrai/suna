...
export default function ContributingPage() {
  return (
    <>
      <DocsHeader
        title="Contributing to Epsilon"
        description="Help make Epsilon better for everyone! We welcome contributions from the community"
            ...
            actions={[
              {
                ...
                variant: 'default',
                onClick: () => window.open('https://github.com/epsilon-ai/chainlens/issues', '_blank')
              }
            ]}
          />
        </div>
