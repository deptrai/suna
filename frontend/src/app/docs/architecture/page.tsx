...
export default function ArchitecturePage() {
  return (
    <>
      <DocsHeader
        title="Platform Architecture"
        subtitle="Understanding the core components and design of the Epsilon platform"
      ...
      <section id="tech-stack" className="mb-16">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Modern technologies powering the Epsilon platform:
          </p>
        </DocsBody>
      ...
      <section id="data-flow" className="mb-16">
        <DocsBody className="mb-8">
          <h2>🔄 Data Flow</h2>
          <p className="text-lg mb-6">
            How information moves through the Epsilon platform:
          </p>
