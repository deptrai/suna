  ...
  return (
    <>
      ...
      <DocsBody className="mb-8">
        ...
        <h3 id="meet-chainlens">Epsilon - Our Flagship Agent</h3>
        <p className="mb-4">
          Epsilon is our showcase agent that demonstrates what's possible with Epsilon. It's a generalist AI worker that can:
        </p>
        ...
        <p className="mb-6">
          Epsilon is completely open source and shows you what you can build with the Epsilon platform.
        </p>
