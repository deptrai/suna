export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('chainlens-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('chainlens-model-selection-v2');
    ...
    localStorage.removeItem('chainlens_upgrade_dialog_displayed');
