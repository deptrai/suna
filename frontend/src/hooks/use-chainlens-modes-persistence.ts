...
// localStorage keys
const SELECTED_MODE_KEY = 'selectedChainLensMode';
...
interface ChainLensModesActions {
...
export function useChainLensModePersistence(): ChainLensModesState & ChainLensModesActions {
