/**
 * TriggerYaml — Read/write .epsilon/triggers.yaml ↔ DB reconciler.
 *
...
export class TriggerYaml {
  ...
  constructor(
    ...
    this.yamlPath = path.join(directory, ".epsilon", "triggers.yaml")
  ...
  startWatching(): void {
    ...
    // Watch the .epsilon directory for triggers.yaml changes
