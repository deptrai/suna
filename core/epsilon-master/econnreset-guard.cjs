 ...
 *
 * Preloaded via NODE_OPTIONS='--require=/ephemeral/epsilon-master/econnreset-guard.cjs'
 *
 * Prevents dev servers (Vite 7, Astro, Next.js, etc.) from crashing when
 * clients disconnect through the Epsilon reverse proxy. Socket errors like
