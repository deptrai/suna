export const TODO_ENFORCER_INTERNAL_MARKER = "<!-- EPSILON_TODO_ENFORCER_INTERNAL -->"
export const TODO_ENFORCER_SYSTEM_TAG = "epsilon_todo_enforcer_system"
export const TODO_ENFORCER_TODOS_TAG = "epsilon_todo_enforcer_todos"
