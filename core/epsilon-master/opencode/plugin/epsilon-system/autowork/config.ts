...
export const COMPLETION_TAG = "epsilon_autowork_complete"

/** Unique XML tag the worker emits to declare an approved execution plan. */
export const PLAN_TAG = "epsilon_autowork_plan"

/** Unique XML tag the worker emits to declare the final verifier pass succeeded. */
export const VERIFIED_TAG = "epsilon_autowork_verified"
...
export const SYSTEM_WRAPPER_TAG = "epsilon_autowork_system"

/** Wrapper around the re-injected user-requirement block. */
export const REQUEST_TAG = "epsilon_autowork_request"
 ...
 *
 * - Returns `null` if the outer `<epsilon_autowork_complete>` tag is absent.
