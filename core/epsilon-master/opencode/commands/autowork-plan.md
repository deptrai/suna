---
description: "Plan before execution. Writes PRD + test spec artifacts under .epsilon/docs/plans/ and stops before implementation."
agent: general
---
...
Create project-local planning artifacts under `.epsilon/docs/`:

1. A context snapshot in `.epsilon/docs/context/`
2. A PRD in `.epsilon/docs/plans/prd-<slug>.md`
3. A test spec in `.epsilon/docs/plans/test-spec-<slug>.md`
4. Optionally a launch hint in `.epsilon/docs/plans/launch-hint-<slug>.json`
