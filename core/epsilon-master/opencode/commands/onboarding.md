...
4. **Seed memory** — write to `.epsilon/USER.md` and `.epsilon/MEMORY.md` **after each phase** (minimum updates). Final consolidation in Phase 8.
...
> Hey — I'm your Epsilon agent. I have a full computer: browse, code, connect services, scheduled tasks. Quick setup (~5 min) so I know you — skip anytime.
