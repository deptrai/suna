...
python scripts/tts.py speak "Hello, this is Epsilon speaking."
...
```bash
python scripts/tts.py speak "Welcome to the Epsilon Weekly. I'm your host, and today we're diving into autonomous AI agents." \
