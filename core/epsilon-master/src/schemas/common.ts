...
export const RotateTokenBody = z.object({
  token: z.string().describe('New EPSILON_TOKEN value'),
})
...
export const HealthResponse = z.object({
  ...
  opencodeStateGuardAvailable: z.boolean().describe('True when epsilon-opencode-state is installed in the runtime'),
  ...
  features: z.object({
    projectsEnabled: z.boolean().describe('When false, the multi-project paradigm is off — no project/ticket tools, no project status hints, /epsilon/projects routes return 503.'),
