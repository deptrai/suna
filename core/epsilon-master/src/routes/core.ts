...
coreRouter.get('/status',
  describeRoute({
    ...
    description: 'Returns Epsilon Master service-manager state for core and bootstrap services.',
...
coreRouter.post('/restart/:service',
  describeRoute({
    ...
    description: 'Restarts a single service managed by Epsilon Master.',
