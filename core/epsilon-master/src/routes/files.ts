 ...
 *
 * Mounted at /file in epsilon-master (e.g. GET /file/raw?path=...).
 *
...
filesRouter.get('/status',
  describeRoute({
    ...
    description: 'Returns the git status of changed files for the current workspace using a fast local implementation in epsilon-master.',
    responses: {
      200: {
