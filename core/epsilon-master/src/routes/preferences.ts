 ...
 *
 * GET  /epsilon/preferences/model   — get current default model
 * PUT  /epsilon/preferences/model   — set or clear default model
 * GET  /epsilon/preferences/models  — list all available models from connected providers
 */
