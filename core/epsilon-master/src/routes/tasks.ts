/**
 * Epsilon Tasks API — task-centric project execution.
 *
...
// ---------------------------------------------------------------------------
// GET /epsilon/tasks?project_id=xxx&status=yyy
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// POST /epsilon/tasks  — create a new task
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// POST /epsilon/tasks/:id/start — start execution (creates worker session)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// POST /epsilon/tasks/:id/approve  — HUMAN review approval → completed
// ---------------------------------------------------------------------------
