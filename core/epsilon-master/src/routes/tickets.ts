/**
 * Epsilon Tickets API — v2 project boards.
 *
...
// ═════════════════════════════════════════════════════════════════════════════
// Project-scoped ticket configuration: /epsilon/projects/:id/{columns,fields,templates,agents,context,seed}
// ═════════════════════════════════════════════════════════════════════════════
...
ticketProjectsRouter.post('/:id/agents', async (c) => {
  ...
  const filePath = join(project.path, '.epsilon', 'agents', `${body.slug}.md`)
  await fs.mkdir(join(project.path, '.epsilon', 'agents'), { recursive: true })
...
/**
 * GET /epsilon/projects/:id/activity?since=<iso>&limit=<n>
 *
