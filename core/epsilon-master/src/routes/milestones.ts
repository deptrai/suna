 ...
 *   - as a project-scoped router under /epsilon/projects/:projectId/milestones
 *   - re-used by agent tools that go through the same HTTP surface
 *
 * Auth/actor:
 *   - Headers X-Epsilon-Actor-Type + X-Epsilon-Actor-Id stamp the actor_type/id on
...
// GET /epsilon/projects/:projectId/milestones
...
// POST /epsilon/projects/:projectId/milestones
...
// GET /epsilon/projects/:projectId/milestones/:ref (id or number)
...
// PATCH /epsilon/projects/:projectId/milestones/:ref
...
// POST /epsilon/projects/:projectId/milestones/:ref/close
...
// POST /epsilon/projects/:projectId/milestones/:ref/reopen
...
// DELETE /epsilon/projects/:projectId/milestones/:ref
...
// GET /epsilon/projects/:projectId/milestones/:ref/events
