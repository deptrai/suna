/**
 * auth-sync — Two-way sync between OpenCode auth.json and Epsilon SecretStore.
 *
...
const AUTH_JSON = process.env.AUTH_JSON_PATH
  || `${process.env.OPENCODE_STORAGE_BASE || `${process.env.EPSILON_PERSISTENT_ROOT || '/persistent'}/opencode`}/auth.json`
