...
//   2. opencode.jsonc instructions[] -> epsilon-system.md body
...
const epsilonSystem = fs.readFileSync("/ephemeral/epsilon-master/opencode/epsilon-system.md", "utf8")
const general = readFileNoFrontmatter("/ephemeral/epsilon-master/opencode/agents/general.md")
...
const projectTokens = [
  ...
  ".epsilon/CONTEXT.md", "project_context_sync",
