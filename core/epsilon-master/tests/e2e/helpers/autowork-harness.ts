...
export async function createAutoworkHarness(sessionId: string, importSalt: string) {
	...
	void importSalt
	const autoworkMod = await import("../../../opencode/plugin/epsilon-system/autowork/autowork.ts")
	const stateMod = await import("../../../opencode/plugin/epsilon-system/autowork/state.ts")
	const todoMod = await import("../../../opencode/plugin/epsilon-system/todo-enforcer/todo-enforcer.ts")
