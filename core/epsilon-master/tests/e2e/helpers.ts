...
export async function startEpsilonMaster(port: number, fixture: RuntimeFixture, extraEnv: Record<string, string> = {}): Promise<StartedServer> {
  const proc = spawn('bun', ['run', 'src/index.ts'], {
    cwd: '/Users/markokraemer/Projects/heyagi/computer/core/epsilon-master',
